...
import com.honeycomb.core.dto.ErrorResponse;
...
public class ErrorHandlerAdvice {
    ...
    public ResponseEntity<ErrorResponse> handleBadRequest(@NonNull IllegalArgumentException ex) {
        ...
        String msg = raw != null ? raw : HoneycombConstants.Messages.EMPTY;
        log.warn(HoneycombConstants.Messages.LOG_BAD_REQUEST, msg, ex);
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(ErrorCode.BAD_REQUEST.toResponse(Objects.requireNonNull(msg)));
    }
    ...
    public ResponseEntity<ErrorResponse> handleGeneric(Exception ex) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ErrorCode.INTERNAL_ERROR.toResponse(Objects.requireNonNull(msg)));
    }
}
